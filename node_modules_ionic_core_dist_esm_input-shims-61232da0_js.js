"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["node_modules_ionic_core_dist_esm_input-shims-61232da0_js"],{

/***/ 4265:
/*!*******************************************************************!*\
  !*** ./node_modules/@ionic/core/dist/esm/input-shims-61232da0.js ***!
  \*******************************************************************/
...
const enableHideCaretOnScroll = (componentEl, inputEl, scrollEl) => {
  ...
  (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_1__.a)(scrollEl, 'ionScrollStart', hideCaret);
  (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_1__.a)(scrollEl, 'ionScrollEnd', showCaret);
  inputEl.addEventListener('blur', onBlur);
  return () => {
    (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_1__.b)(scrollEl, 'ionScrollStart', hideCaret);
    (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_1__.b)(scrollEl, 'ionScrollEnd', showCaret);
...
const enableInputBlurring = () => {
  ...
  (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_1__.a)(doc, 'ionScrollStart', onScroll);
  doc.addEventListener('focusin', onFocusin, true);
  doc.addEventListener('touchend', onTouchend, false);
  return () => {
    (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_1__.b)(doc, 'ionScrollStart', onScroll, true);
...
const enableScrollAssist = (componentEl, inputEl, contentEl, footerEl, keyboardHeight) => {
  ...
  const touchStart = ev => {
    coord = (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_1__.p)(ev);
  };
  ...
  const touchEnd = ev => {
    ...
    const endCoord = (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_1__.p)(ev); // focus this input if the pointer hasn't moved XX pixels
...
const jsSetFocus = /*#__PURE__*/function () {
  var _ref = (0,D_projects_qubit_qrreader_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (componentEl, inputEl, contentEl, footerEl, keyboardHeight) {
    ...
    (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_1__.r)(() => componentEl.click());
    ...
    if (typeof window !== 'undefined') {
      ...
      const scrollContent = /*#__PURE__*/function () {
        var _ref2 = (0,D_projects_qubit_qrreader_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
...
const startInputShims = config => {
  ...
  const registerInput = /*#__PURE__*/function () {
    var _ref3 = (0,D_projects_qubit_qrreader_node_modules_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (componentEl) {
      yield new Promise(resolve => (0,_helpers_6e1e5b65_js__WEBPACK_IMPORTED_MODULE_1__.c)(componentEl, resolve));
...
//# sourceMappingURL=node_modules_ionic_core_dist_esm_input-shims-61232da0_js.js.map